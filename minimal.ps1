...
.hero-thumb{width:160px;background:#f0f5e8;border-radius:8px;padding:16px;text-align:center;box-shadow:0 4px 16px rgba(0,0,0,0.06);transition:transform 0.3s}
.hero-thumb:hover{transform:translateY(-4px)}
.hero-thumb img{width:100%;height:120px;object-fit:contain;margin-bottom:12px}
...
.hero-thumb-circle img{width:80px;height:80px;object-fit:cover;border-radius:50%}
</style>
</head>
<body>
...
Write-Host "IMG: $(([regex]::Matches($html, '<img src')).Count)"
